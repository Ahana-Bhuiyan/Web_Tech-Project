...
<body>
	<fieldset style="background-color: #93B4FF">
        ...
        <div style="float: right;">
            <a href="/Project/View/login.php">Login</a> | <a href="/Project/Home.php">Home</a>
        </div>
    </fieldset>

	<br>

	<div align="center" style="width:600px; margin-left:auto; margin-right: auto; background-color: #D884FF;">
		<fieldset>
