<?php
	...
	#----- Data storing-----#
		if($isValid){
			// define("file", '/Windows Application/Installed(64x)/xampp/htdocs/ProjectEZ/Model/tempTeacher.json');
   //          $handle = fopen(file, "r");
   //          $json = NULL;
   ...
   //          fclose($handle);
			...
			insert_manager($name, $gender, $dob, $phone, $email, $username, $password);
            setcookie('msg', '<b>✅ Registration Successful.', time() + 1, '/');
