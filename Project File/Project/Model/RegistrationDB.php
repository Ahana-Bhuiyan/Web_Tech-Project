<?php
    ...
    function insert_manager($name, $gender, $dob, $phone, $email, $username, $password) {
        $ezl = connect();

        $sql = "INSERT INTO customers(Name, Gender, DateOfBirth, Email, Contact, Username, Password) VALUES ('$name', '$gender', '$dob', '$email', '$phone', '$username', '$password')";
